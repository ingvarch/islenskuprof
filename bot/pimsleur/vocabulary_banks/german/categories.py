"""
German vocabulary categories and unit themes.

Based on analysis of 30 real Pimsleur German transcriptions.
Each level has 30 units with specific themes and CEFR targets.

Level 1: A1-A2 (Survival German) - 500 words
Level 2: A2-B1 (Conversational German) - 500 words
Level 3: B1-B2 (Fluent German) - 500 words
"""
...
UNIT_THEMES = {
    # Level 1: A1-A2 (Survival German)
    1: {
        1: ("survival_skills", "Excuse Me, Do You Understand?"),
        2: ("meet_greet", "Hello, How Are You?"),
        3: ("nationalities", "Are You German?"),
        4: ("directions_basic", "Yes, You Do Speak German!"),
    ...
    # Level 2: A2-B1 (Conversational German)
    2: {
        ...
        23: ("culture_basic", "German Traditions"),
    ...
    3: {
        ...
        17: ("history_culture", "German History"),
        ...
        22: ("humor_sarcasm", "German Humor"),
        23: ("regional_dialects", "Dialect Awareness"),
        24: ("old_German", "Classical German"),
