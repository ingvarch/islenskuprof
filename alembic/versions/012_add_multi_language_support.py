...
def upgrade():
    ...
    # Activities table
    op.add_column(
        "activities", sa.Column("language_code", sa.String(10), nullable=True)
    )
    ...
    op.add_column(
        "user_settings", sa.Column("target_language_id", sa.Integer, nullable=True)
    )
...
def downgrade():
    ...
    op.drop_constraint(
        "fk_user_settings_target_language_id", "user_settings", type_="foreignkey"
    )
