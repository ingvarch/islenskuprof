...
def upgrade():
    logger.info(
        "Applying migration %s: Adding languages table and language_id to users table",
        revision,
    )
...
def downgrade():
    logger.info(
        "Rolling back migration %s: Removing language_id from users table and dropping languages table",
        revision,
    )
